...
export class AnalyticsPage implements OnInit, ViewDidEnter {
  ...
  analyticsUsersPunctuality$: Observable<IAnalyticsUsersPunctuality> = null;
  analyticsUsersInteractivity$: Observable<IAnalyticsUsersInteractivity> = null;
  ...
  getAnalytics() {
    ...
    this.getAnalyticsUsersPunctuality();
    this.getAnalyticsUsersInteractivity();
    this.getAnalyticsPresenceClasses();
  }

  getAnalyticsPresenceCounts() {
    this.analyticsPresenceCounts$ =
      this.analyticsService.getAnalyticsPresenceCounts();
  }

  getAnalyticsPresenceHistory() {
    this.analyticsPresenceHistory$ =
      this.analyticsService.getAnalyticsPresenceHistory();
  }

  getAnalyticsPresenceUsers() {
    this.analyticsPresenceUsers$ =
      this.analyticsService.getAnalyticsPresenceUsers();
  }

  getAnalyticsUsersPunctuality() {
    this.analyticsUsersPunctuality$ =
      this.analyticsService.getAnalyticsUsersPunctuality();
  }

  getAnalyticsUsersInteractivity() {
    this.analyticsUsersInteractivity$ =
      this.analyticsService.getAnalyticsUsersInteractivity();
  }

  updatePresenceClasses({ startDate, endDate, year, month, day }: DateFilter) {
  ...
  getAnalyticsPresenceClasses() {
    this.analyticsPresenceClassInfos$ =
      this.analyticsService.getAnalyticsPresenceClassInfos(
